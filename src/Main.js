...
export default function Main() {
    ...
    // used to store cart quantity when user clicks on plus button
    const [cartQuantity, setCartQuantity] = useState(0)

    // used to show loading message while products are being fetched from the database
    const [loading, setLoading] = useState(true)

    // used to set cart items that are added to the cart and to pass them to the Checkout page
    const [cart, setCart] = useState([])

    // used to show the total amount of the cart items
    ...
    return (
        <div className="App">
                ...
                <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
                    ...
                    <div className="order-2 md:order-3 flex items-center" id="nav-content">
                        ...
                        <p className="pl-3 inline-block no-underline hover:text-black"
                            ...
                            <span
                                className="inline-flex absolute top-4 justify-center items-center w-5 h-5 text-xs font-bold text-white bg-red-500 rounded-full">{cartQuantity}
                            </span>
                        </p>
                    </div>
                </div>
            ...
            {/* Hero */}
            <div
                className="hero w-full mx-auto bg-nordic-gray-light flex pt-12 md:pt-0 md:items-center bg-cover bg-right" style={{ height: '32rem', backgroundImage: "url(" + 'https://images.unsplash.com/photo-1422190441165-ec2956dc9ecc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1600&q=80' }}>
