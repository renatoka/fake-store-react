                ...
                <div className="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
                    ...
                    <div className="order-2 md:order-3 flex items-center" id="nav-content">
                        ...
                        <p className="pl-3 inline-block no-underline hover:text-black">
                            ...
                            <span
                                className="inline-flex absolute top-4 justify-center items-center w-5 h-5 text-xs font-bold text-white bg-red-500 rounded-full">{cartItems}</span>
                        </p>
                    </div>
                </div>
            </nav>
            ...
            <div
                ...
                <div className="container mx-auto">
                    <div className="flex flex-col w-full lg:w-1/2 justify-center items-start  px-6 tracking-wide">
                        <h1 className="text-left text-black text-2xl my-4">Stripy Zig Zag Jigsaw Pillow and Duvet
                            Set</h1>
                        <p className="text-xl inline-block no-underline border-b border-gray-600 leading-relaxed hover:text-black hover:border-black">products</p>
                    </div>
                </div>
            </div>
            {/* Products */}
                        ...
                        return (<div className="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col" key={id}>
                            <div>
                                ...
                                <div className="pt-3 flex items-center justify-between">
                                    ...
                                    <img src={plus} width='20px' onClick={updateCart}
                                         alt={description}/>
                                </div>
