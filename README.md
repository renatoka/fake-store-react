...
Fake eCommerce Store web application made with React and powered by 'Fake Store API'.
Browse your favorite products, add them to a cart, checkout and track your order.
...
1. Clone the repo
   ```sh
   git clone https://github.com/renatoka/fake-store-react
   ```
